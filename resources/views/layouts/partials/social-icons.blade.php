@php
    ...
    $social = [
        'youtube' => trim((string) config('social.youtube_url', 'https://youtube.com')),
        'facebook' => trim((string) config('social.facebook_url', 'https://facebook.com')),
        'x' => trim((string) config('social.x_url', 'https://x.com')),
        'instagram' => trim((string) config('social.instagram_url', 'https://instagram.com')),
        'linkedin' => trim((string) config('social.linkedin_url', 'https://linkedin.com')),
        'whatsapp' => trim((string) config('social.whatsapp_url', 'https://wa.me/256787726388')),
    ];
@endphp

<div class="{{ $containerClass }}">
    @if($social['youtube'] !== '')
        <a href="{{ $social['youtube'] }}" class="{{ $iconClass }}" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
    ...
    @endif
    @if($social['facebook'] !== '')
        <a href="{{ $social['facebook'] }}" class="{{ $iconClass }}" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <svg viewBox="0 0 24 24" fill="none" class="h-4 w-4" aria-hidden="true">
    ...
    @endif
    @if($social['x'] !== '')
        <a href="{{ $social['x'] }}" class="{{ $iconClass }}" target="_blank" rel="noopener noreferrer" aria-label="X">
            <svg viewBox="0 0 24 24" fill="none" class="h-4 w-4" aria-hidden="true">
    ...
    @endif
    @if($social['instagram'] !== '')
        <a href="{{ $social['instagram'] }}" class="{{ $iconClass }}" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            <svg viewBox="0 0 24 24" fill="none" class="h-4 w-4" aria-hidden="true">
    ...
    @endif
    @if($social['linkedin'] !== '')
        <a href="{{ $social['linkedin'] }}" class="{{ $iconClass }}" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <svg viewBox="0 0 24 24" fill="none" class="h-4 w-4" aria-hidden="true">
    ...
    @endif
    @if($social['whatsapp'] !== '')
        <a href="{{ $social['whatsapp'] }}" class="{{ $iconClass }}" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
            <svg viewBox="0 0 24 24" fill="none" class="h-4 w-4" aria-hidden="true">
