<header class="header-shell sticky top-0 z-50 border-b border-[color:rgba(19,242,198,0.2)]" :class="{ 'scrolled': scrolled }">
    <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-20 items-center gap-4">
            <a href="{{ route('home') }}" class="group flex shrink-0 items-center gap-3">
                <span class="font-heading text-xl tracking-[0.26em] sm:text-2xl">ARO<span class="text-[var(--accent)]">SOFT</span></span>
                <span class="hidden text-[0.58rem] uppercase tracking-[0.24em] muted-faint xl:block">Innovations Ltd</span>
            </a>
                ...
                <div class="relative" @mouseenter="openMega('services')" @mouseleave="closeMega('services')">
                    ...
                    >
                        ...
                        <div class="mt-3 grid grid-cols-2 gap-3">
                            <a href="{{ route('services.printing') }}" class="shell-card rounded-xl p-4 transition duration-200 hover:border-[color:rgba(19,242,198,0.48)]">
                            ...
                            <a href="{{ route('services.website-design') }}" class="shell-card rounded-xl p-4 transition duration-200 hover:border-[color:rgba(19,242,198,0.48)]">
                            ...
                            <a href="{{ route('services.web-development') }}" class="shell-card rounded-xl p-4 transition duration-200 hover:border-[color:rgba(19,242,198,0.48)]">
                            ...
                            <a href="{{ route('services.training-courses') }}" class="shell-card rounded-xl p-4 transition duration-200 hover:border-[color:rgba(19,242,198,0.48)]">
                    ...
                    >
                        ...
                        <div class="mt-4 grid grid-cols-2 gap-3">
                            <template x-for="video in videos.slice(0, 4)" :key="video.title">
                                <a :href="video.url" class="group overflow-hidden rounded-xl border border-[color:rgba(19,242,198,0.2)] transition duration-200 hover:border-[color:rgba(19,242,198,0.52)]">
                                    <div
                                        class="h-24 w-full border-b border-[color:rgba(19,242,198,0.2)] bg-[color:rgba(5,11,20,0.82)] bg-cover bg-center"
                                        :style="`background-image:url('${video.thumb}')`"
                                    ></div>
                                    <div class="space-y-1 p-3">
                                        <p class="text-sm font-semibold leading-snug text-[color:rgba(230,240,255,0.92)]" x-text="video.title"></p>
            ...
            <div class="ml-auto hidden items-center gap-3 lg:flex">
                <div class="relative w-80" @click.outside="closeSearch()">
                    <svg viewBox="0 0 24 24" fill="none" class="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[color:rgba(230,240,255,0.56)]" aria-hidden="true">
