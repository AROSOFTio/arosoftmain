        ...
        foreach ($configuredCategories as $categoryIndex => $category) {
            ...
            foreach (($category['tools'] ?? []) as $toolIndex => $tool) {
                ...
                $mappedTool = [
                    ...
                    'allows_multiple' => (bool) ($tool['allows_multiple'] ?? false),
                    'min_files' => $tool['min_files'] ?? null,
                    'max_files' => $tool['max_files'] ?? null,
                    'upload_help_text' => (string) ($tool['upload_help_text'] ?? ''),
